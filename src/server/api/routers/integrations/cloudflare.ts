...
import { users, websites, visitors, pageViews } from "@/server/db/schema"
...
export const cloudflareRouter = router({
  saveToken: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const { listCloudflareZones } = await import("@/lib/cloudflare-analytics")
  ...
  sync: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const { fetchCloudflareFullSync } = await import("@/lib/cloudflare-analytics")
