...
import { websites, visitors, pageViews, visitorSessions } from "@/server/db/schema"
...
export const posthogRouter = router({
  connect: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const { validatePostHogCredentials } = await import("@/lib/posthog-api")
  ...
  sync: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const { fetchPostHogDailyStats, fetchPostHogBreakdowns } = await import("@/lib/posthog-api")
