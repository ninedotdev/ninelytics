...
export default function ReportsPage() {
  ...
  const { data: analyticsData, isLoading: loadingAnalytics } = api.analytics.overview.useQuery(
    {
  ...
  const { data: devicesData, isLoading: loadingDevices } = api.analytics.devices.useQuery(
    {
      websiteId: selectedWebsite,
      startDate: startDateStr,
      endDate: endDateStr,
  ...
  const { data: pagesData, isLoading: loadingPages } = api.analytics.pages.useQuery(
    {
      websiteId: selectedWebsite,
      startDate: startDateStr,
      endDate: endDateStr,
  ...
  const { data: trafficData, isLoading: loadingTraffic } = api.analytics.traffic.useQuery(
    {
      websiteId: selectedWebsite,
      startDate: startDateStr,
      endDate: endDateStr,
        ...
        >
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div className="flex items-center text-sm mt-1">
                    <span
                      className={getTrendColor(
                        reportData.executive?.trends.visitorsChange || 0
                      )}
                    >
                      {getTrendIcon(
                        reportData.executive?.trends.visitorsChange || 0
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="flex items-center text-sm mt-1">
                    <span
                      className={getTrendColor(
                        reportData.executive?.trends.pageViewsChange || 0
                      )}
                    >
                      {getTrendIcon(
                        reportData.executive?.trends.pageViewsChange || 0
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {formatDuration(
                      reportData.executive?.avgSessionDuration || 0
                    )}
                  </div>
                  <div className="flex items-center text-sm mt-1">
                    <span
                      className={getTrendColor(
                        reportData.executive?.trends.sessionChange || 0
                      )}
                    >
                      {getTrendIcon(
                        reportData.executive?.trends.sessionChange || 0
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="flex items-center text-sm mt-1">
                    <span
                      className={getTrendColor(
                        -(reportData.executive?.trends.bounceChange || 0)
                      )}
                    >
                      {getTrendIcon(
                        -(reportData.executive?.trends.bounceChange || 0)
          ...
          <TabsContent value="traffic" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                {reportData?.traffic?.sources &&
                reportData.traffic.sources.length > 0 ? (
                  <div className="space-y-4">
                  ...
                  <div className="text-center py-12 text-gray-500">
                    ...
                    <p className="text-sm mt-2">
                      Data will appear as visitors start arriving
                    </p>
                  </div>
                )}
              </CardContent>
            ...
            {/* Campaigns */}
            {reportData?.traffic?.campaigns &&
              reportData.traffic.campaigns.length > 0 && (
                <Card>
                  <CardHeader>
            ...
            {/* Top Referrers */}
            {reportData?.traffic?.referrers &&
              reportData.traffic.referrers.length > 0 && (
                <Card>
                  <CardHeader>
          ...
          <TabsContent value="behavior" className="space-y-6">
            <Card>
              ...
              <CardContent>
                {reportData.behavior?.topPages &&
                reportData.behavior.topPages.length > 0 ? (
                  <div className="space-y-4">
          ...
          <TabsContent value="technology" className="space-y-6">
            <Card>
              ...
              <CardContent>
                {reportData.technology?.devices &&
                reportData.technology.devices.length > 0 ? (
