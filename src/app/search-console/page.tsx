...
export default function SearchConsolePage() {
  ...
  const { data: summary, isLoading: loadingSummary } = api.searchConsole.getSummary.useQuery(
    { websiteId: selectedWebsite, days },
    { enabled: !!selectedWebsite }
  );

  const { data: timeSeries, isLoading: loadingTimeSeries } = api.searchConsole.getTimeSeries.useQuery(
    { websiteId: selectedWebsite, days },
    { enabled: !!selectedWebsite }
  );
