...
export default function GoalDetailPage({
  ...
  const { data: goalData, isLoading: loadingGoal, error: goalError } = api.goals.byId.useQuery(
    { id: resolvedParams.id }
  );

  const { data: statsData, isLoading: loadingStats } = api.goals.stats.useQuery(
    { id: resolvedParams.id, days: parseInt(dateRange) },
    {
      enabled: !!goalData,
    }
  );
