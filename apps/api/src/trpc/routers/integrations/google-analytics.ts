...
import { users, websites, visitors, pageViews, visitorSessions } from "@ninelytics/db/schema"
...
export const googleAnalyticsRouter = router({
  saveCredentials: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const { validateGACredentials } = await import("@ninelytics/shared/google-analytics")
  ...
  listProperties: protectedProcedure
    .query(async ({ ctx }) => {
      ...
      const { listGAProperties } = await import("@ninelytics/shared/google-analytics")

      if (user?.googleAccessToken && user?.googleRefreshToken) {
        const { getValidAccessToken } = await import("@ninelytics/shared/google-oauth")
  ...
  sync: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const { fetchGAAnalytics, fetchGABreakdowns } = await import("@ninelytics/shared/google-analytics")
  ...
  getAuthUrl: protectedProcedure
    .query(async ({ ctx }) => {
      const { getGoogleAuthUrl } = await import("@ninelytics/shared/google-oauth")
  ...
  disconnect: protectedProcedure
    .mutation(async ({ ctx }) => {
      ...
      if (user?.googleAccessToken) {
        const { revokeGoogleTokens } = await import("@ninelytics/shared/google-oauth")
