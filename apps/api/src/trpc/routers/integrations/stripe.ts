...
import { websites, stripeData } from "@ninelytics/db/schema"
...
export const stripeRouter = router({
  connect: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const { validateStripeKey } = await import("@ninelytics/shared/stripe-api")
  ...
  sync: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const { fetchStripeRevenue } = await import("@ninelytics/shared/stripe-api")
