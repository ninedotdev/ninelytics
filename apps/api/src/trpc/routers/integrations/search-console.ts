...
import { users, websites, searchConsoleData } from "@ninelytics/db/schema"
...
export const searchConsoleRouter = router({
  ...
  listSites: protectedProcedure
    .query(async ({ ctx }) => {
      ...
      const { listSearchConsoleSites } = await import("@ninelytics/shared/search-console")
  ...
  sync: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const { fetchSearchConsoleData, fetchSearchConsoleDailyTotals } = await import("@ninelytics/shared/search-console")
      ...
      try {
        const { checkIntegrationGoals } = await import("@ninelytics/shared/integration-goals")
